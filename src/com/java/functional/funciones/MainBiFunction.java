...
public class MainBiFunction {
	...
	public static void main(String[] args) {
		...
		/*
		 * Interface funcional BiFunction que recibe dos par�metros (Object T, Object U) y devuelve uno (Object R)
		 * Los argumentos pueden ser de diferentes tipos
		 * Interface BiFunction(T t, U u, R r)
		 * Tiene un m�todo abstracto que recibe dos objetos apply(T t, U u)
		 */
		...
		//Ejemplo de BiFunctioncon un m�todo de otra clase
		...
		user.stream().forEach(u -> logger.debug("El usuario \u001b[36m {} \u001B[0m de \u001b[36m {} \u001B[0m a�os de edad con un sueldo de \u001b[36m {} \u001B[0m tuvo un aumento que equivale a: \u001b[36m {} \u001B[0m", 
